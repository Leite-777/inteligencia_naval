 ...
 */
let infoNumeroJogadas = document.getElementById('info-numero-jogadas') as HTMLParagraphElement;
let numeroJogadas = 0;
...
*/
let infoJogandoAgora = document.getElementById('info-jogando-agora') as HTMLParagraphElement;
